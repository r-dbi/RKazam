...
- Derive `README.md` from a `README.Rmd` (#115).

- State the goals and non-goals (#114).
...
- Auto-update from GitHub Actions (#89).
...
- Auto-update from GitHub Actions (#87).
